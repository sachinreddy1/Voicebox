...
class EditCellAdapter(val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) =
        (holder as EditCellAdapter.EditCellViewHolder).setBarNumber(position)
